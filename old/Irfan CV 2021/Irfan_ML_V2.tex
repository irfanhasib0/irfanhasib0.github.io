...
>> Worked on \textbf{anomaly detection, visual change detection} on infrastructure from image data.\\
>> Develop and maintain the \textbf{Machine Learning Pipeline} for production environment. Frequently work with \textbf{Python, AWS, CI/CD , Linux systems, Docker} etc.
