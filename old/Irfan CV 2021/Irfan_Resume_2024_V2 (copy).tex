...
\begin{document}
\begin{textblock}{20}(1.0,1.5)
\Large\color{mainblue}{Irfan Mohammad Al Hasib}\\ % Your name
\Large\color{black}{Machine Learning Researcher} % Job title/career
\end{textblock}

%\profilepic{} % irfan.jpg Profile picture
% 19 November 1993 Date of birth
